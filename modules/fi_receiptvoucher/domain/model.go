...
type ReceiptvoucherDetails struct {
	SOID              int       `json:"SOID,omitempty" db:"SOID"`
...
type ReceiptvoucherPackage struct {
	Receiptvoucher        Receiptvoucher          `json:"Receiptvoucher,omitempty"`
	ReceiptvoucherDetails []ReceiptvoucherDetails `json:"ReceiptvoucherDetails,omitempty"`
}

var List []Receiptvoucher
