...
type SalesinvoicePackage struct {
	Salesinvoice        Salesinvoice          `json:"Salesinvoice,omitempty"`
	SalesinvoiceDetails []SalesinvoiceDetails `json:"SalesinvoiceDetails,omitempty"`
}
