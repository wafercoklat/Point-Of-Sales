...
type PurchaseinvoiceDetails struct {
	SOID              int       `json:"SOID,omitempty" db:"SOID"`
...
type PurchaseinvoicePackage struct {
	Purchaseinvoice        Purchaseinvoice          `json:"Purchaseinvoice,omitempty"`
	PurchaseinvoiceDetails []PurchaseinvoiceDetails `json:"PurchaseinvoiceDetails,omitempty"`
}
